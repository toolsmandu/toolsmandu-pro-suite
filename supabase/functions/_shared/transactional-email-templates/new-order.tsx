...
const hero = { padding: '8px 32px 28px', textAlign: 'center' as const }
const eyebrow = {
...
const heroSub = { fontSize: '15px', color: '#5b6473', lineHeight: '1.6', margin: '0 0 20px', textAlign: 'left' as const }
